...
import { authstore, TokenStore, wispcraftSettings, saveWispcraftSettings } from ".";
...
export function createUI() {
            ...
            <div class="content hidden" id="about">
                <div class="setting">
                  ...
                  <ul class="list">
                    ...
                    <li>Using your Minecraft account on Wispcraft may lead to a server taking action on your account. Some servers, like Hypixel, have a use-at-your-own-risk policy for third party modifications, including Eaglercraft and Wispcraft. Appealing false bans may not be possible or successful!</li>
                  </ul>
                </div>
            </div>
        </div>`;
    ...
    const forceMotdCacherCheckbox = document.querySelector("#force_motd_cacher") as HTMLInputElement;
    ...
    forceMotdCacherCheckbox.checked = wispcraftSettings.forceMotdCacher;
    ...
    forceMotdCacherCheckbox.onchange = () => {
        wispcraftSettings.forceMotdCacher = forceMotdCacherCheckbox.checked;
        saveWispcraftSettings();
    };
